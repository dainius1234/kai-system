.PHONY: go_no_go hardening_smoke build-kai-control kai-control-selftest test-conviction kai-drill kai-drill-test test-self-emp test-medic
...
test-medic:
	PYTHONPATH=. python scripts/test_medic_scan.py

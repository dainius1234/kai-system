...
# Repo-wide HTTP/time hygiene scale (not a gate). See W1_GLOBAL_HYGIENE_SUBPLAN.md
hygiene-survey:
...
test-uh: test-contracts test-perception-spine test-world-state \
	...
	test-dashboard-ui-auth test-degraded

...
def test_langgraph_chat_route_override_from_wake_intent(monkeypatch):
    ...
    monkeypatch.setattr(lg_mod, "_read_mode", fake_get_mode)
    monkeypatch.setattr(lg_mod, "_recall_memories", _empty_list)
    monkeypatch.setattr(lg_mod, "_recall_session", _empty_list)
    monkeypatch.setattr(lg_mod, "_read_active_goals", _empty_list)
    monkeypatch.setattr(lg_mod, "_read_active_topics", _empty_list)
    monkeypatch.setattr(lg_mod, "_feel_emotional_context", _empty_dict)
    monkeypatch.setattr(lg_mod, "_hold_narrative", _empty_dict)
    monkeypatch.setattr(lg_mod, "_imagine_context", _empty_dict)
    monkeypatch.setattr(lg_mod, "_hold_conscience", _empty_dict)
    monkeypatch.setattr(lg_mod, "_surface_agent_context", _empty_dict)
    monkeypatch.setattr(lg_mod, "_understand_operator", _empty_dict)
